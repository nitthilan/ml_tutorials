...
#   - Modifications to be done on MobileNet to be working running on Mobile
...
def MobileNet(input_shape=None,
    ...
    N1=int(8*num_filter);
    N2=2*N1; N3=2*N2; N4=2*N3; N5=2*N4; N6=2*N5
    # if(num_filters==4):
    # elif(num_filters==3):
    # elif(num_filters==2):
    # elif(num_filters==1):

    x = _conv_block(img_input, N1, alpha, strides=(2, 2))
    x = _depthwise_conv_block(x, N2, alpha, depth_multiplier, block_id=1)

    x = _depthwise_conv_block(x, N3, alpha, depth_multiplier,
                              strides=(2, 2), block_id=2)
    x = _depthwise_conv_block(x, N3, alpha, depth_multiplier, block_id=3)

    x = _depthwise_conv_block(x, N4, alpha, depth_multiplier,
