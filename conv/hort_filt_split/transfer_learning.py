...
resize_factor = int(sys.argv[3]) # (0) 1 2 3
weight_path = sys.argv[4] # Path to pre-trained networks
# weight_path = "../../data/ml_tutorial/conv/cifar10_conv_v0/keras_cifar10_weight_0.h5"
# weight_path = "./saved_models/keras_cifar10_weight_0.h5"#WRN
# weight_path = "../../data/conv/mnist_conv_v0/keras_mnist_weight_0.h5"#Conv
# weight_path = "../../data/conv/cifar100_vgg_v2/cifar100vgg_v1.h5" #vgg 100
# weight_path = "../../data/conv/saved_model_vgg_v0/keras_cifar10_weight_0.h5"
# weight_path = "../../../data/ml_tutorial/conv/cifar100_vgg_v2/"
...
with tf.device('/gpu:0'):
  if(network == "wrn"):
    ...
    model = gcn.get_conv_net(x_train.shape[1:], \
      ...
      wgt_fname=weight_path)
  elif(network == "vgg" and data_set == "cifar100"):
    ...
    print("Invalid network combination ")
    exit(0)
