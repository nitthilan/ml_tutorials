...
class cifar100vgg:
    def __init__(self,train=False):
        ...
        if train:
            ...
            self.model.load_weights('cifar100vgg_v1.h5')
    ...
    def train(self,model):
        ...
        modelCheckpoint = ModelCheckpoint('cifar100vgg_v1.h5', 
        ...
        historytemp = model.fit_generator(datagen.flow(x_train, y_train,
                            ...
                            callbacks=[reduce_lr, modelCheckpoint],verbose=2)
